...
const TestimonialsSection = ({ content }: { content: TestimonialsSectionContent }) => {
  const freshContent = useFreshLandingContent(content, 'testimonials')
  ...
  return <Testimonials testimonials={freshContent.items} content={{ title: freshContent.title, description: freshContent.description }} />
}
