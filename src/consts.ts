...
export const SITE_TITLE = 'Demo: Orion - AI Agent Landing Page | Shadcn Studio'
...
export const GITHUB_URL = 'https://github.com/yourusername/shadcn-astro-orion-landing-page'
export const SITE_URL = 'https://shadcn-astro-orion-landing-page.vercel.app/'

export const SITE_METADATA = {
  title: {
    default: 'Demo: Orion - AI Agent Landing Page | Shadcn Studio'
  },
  description:
    'Automate routine tasks, connect your tools, and let your AI agent coordinate workflows so you can focus on strategy, not busywork. Boost productivity with intelligent automation.',
  keywords: [
  ...
  openGraph: {
    ...
    locale: 'en_US',
    siteName: 'Orion',
    title: 'Orion - AI Agent Landing Page | Shadcn Studio',
    description:
      'Automate routine tasks, connect your tools, and let your AI agent coordinate workflows so you can focus on strategy, not busywork. Boost productivity with intelligent automation.',
    images: [
      {
