...
**Skill page (skills.sh):** [writing-skills](https://skills.sh/obra/superpowers/writing-skills)

**Upstream repository:** [obra/superpowers](https://github.com/obra/superpowers)

**Session match:** No

**Weekly installs (public):** `36.1K`

> [!success] Overall security signal
> Snapshot: **Success** — clean pass across all three auditors at extraction time.

> [!abstract] Summary
> Authoring and maintaining high-quality agent skills (Obra Superpowers).
...
| Audit               | Result                                                                                         |
| :------------------ | :--------------------------------------------------------------------------------------------- |
| Gen Agent Trust Hub | **PASS** [Details](https://skills.sh/obra/superpowers/writing-skills/security/agent-trust-hub) |
| Socket              | **PASS** [Details](https://skills.sh/obra/superpowers/writing-skills/security/socket)          |
| Snyk                | **PASS** [Details](https://skills.sh/obra/superpowers/writing-skills/security/snyk)            |
|                     |                                                                                                |
