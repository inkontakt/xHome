...
**Skill page (skills.sh):** [wp-rest-api](https://skills.sh/wordpress/agent-skills/wp-rest-api)
...
> [!abstract] Summary
> Official WordPress organisation skill: REST API usage and conventions for agents.
...
| Audit | Result |
| :--- | :--- |
| Gen Agent Trust Hub | **PASS** [Details](https://skills.sh/wordpress/agent-skills/wp-rest-api/security/agent-trust-hub) |
| Socket | **PASS** [Details](https://skills.sh/wordpress/agent-skills/wp-rest-api/security/socket) |
| Snyk | **PASS** [Details](https://skills.sh/wordpress/agent-skills/wp-rest-api/security/snyk) |
